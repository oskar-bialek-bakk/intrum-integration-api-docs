...
| API staging database (dm\_integration\_[klient]) | Baza danych API Integracyjnego wykorzystywana do przetwarzania danych zanim finalnie zostaną one zaimportowane do bazy DEBT Manager |
...
| DEBT Manager database (dm\_data\_dmweb\_[klient]) | Baza danych systemu DEBT Manager do której importowane są dane |
